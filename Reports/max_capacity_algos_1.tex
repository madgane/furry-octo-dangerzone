...
\label{mca1-e1}
\end{eqnarray}
and the metric used at other entries are the measure of area / volume subtended by the channel vectors of users at \me{i^\mrm{th}} row and \me{j^\mrm{th}} column along with channel vectors already selected in the previous iteration. This is given as follows,
\begin{eqnarray}
